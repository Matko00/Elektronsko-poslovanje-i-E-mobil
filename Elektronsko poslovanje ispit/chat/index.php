    ...
    <div class="container p-0 mb-2" style="margin-top: 50px;">
        <div class="card" style="transform: none; box-shadow:none;">
            <div class="text-center fs-4 card-header" style="background-color: #ccc;">
                <b style="text-transform: uppercase; color:#666;">Chat</b>
            </div>
            <div class="card-body">
            <?php
                ...
                <div class='d-flex gap-5 flex-wrap'>
                    ...
                    ";
                        for ($i=0; $i < sizeof($data); $i++) { 
                            ...
                            if($value['id_user'] != $_SESSION['id_user']){
                                echo "<div onclick=\"showMessages($value[id_user])\" class='messages-user'><span class='notification-chat'>$value[seen]</span>  $value[email] </div>";
                            } 
                        }
                    echo "</form>
                    ...
                    <div class='messagebox' style='width: calc((70%) - 1.5rem);'>
                        <form action='#' class='messages'>
                            <div style='text-align:center;'>Select a user to chat with</div>
                        </form>
